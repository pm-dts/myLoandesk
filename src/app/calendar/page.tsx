        ...
        <main className="min-h-screen bg-primary-bg pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pt-10 lg:pb-24 text-ink">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <header className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
                    ...
                    <h1 className={cn("text-3xl sm:text-5xl tracking-tight text-ink font-light leading-tight mb-4", fraunces.className)}>
                        Book a Consultation{" "}
                    ...
                    <p className="text-sm sm:text-base text-ink-2 leading-relaxed">
                        Select a time that works best for your schedule to speak directly with our origination talent team.
                    </p>
                </header>
                ...
                <div className="relative w-full mx-auto">
                    ...
                    <div className="relative z-10 bg-primary-bg border border-line rounded-[24px] sm:rounded-[32px] p-2 sm:p-6 shadow-2xl overflow-hidden min-h-[600px]">
                        ...
                        <iframe
                            src="https://api.leadconnectorhq.com/widget/booking/R6T9U7pD0SbNSfFFqHrY"
                            style={{ width: '100%', minHeight: '650px', border: 'none', overflow: 'hidden' }}
                            scrolling="no"
                            id="R6T9U7pD0SbNSfFFqHrY_1784097010430"
                            title="LeadConnector Booking Calendar"
                ...
                <p className="text-[11px] text-center text-ink-2/70 mt-8 max-w-md mx-auto">
                    Calendar connection is heavily encrypted. All appointments instantly generate private calendar invites and diagnostic meeting links.
                </p>
