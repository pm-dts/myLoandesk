        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "xxj3anvhgr");
            `,
          }}
        />

        {/* Google Analytics 4 */}
        <GoogleAnalytics gaId={process.env.NEXT_PUBLIC_GA_ID || "G-CJ020K1251"} />

        <GoogleTagManager gtmId={process.env.NEXT_PUBLIC_GTM_ID || "GTM-M3N83T74"} />
      </body>
    </html>
  );
}