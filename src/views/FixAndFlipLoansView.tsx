...
export async function getFixAndFlipLoansMetadata(
  locale: "en" | "es",
): Promise<Metadata> {
  const isEs = locale === "es";
  const t = await getTranslations({
    locale,
    namespace: "FixAndFlipLoans.meta",
  });

  const canonicalUrl = isEs
    ? "https://www.myloandesk.com/es/loan-programs/fix-and-flip-loans/"
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: "https://www.myloandesk.com/loan-programs/fix-and-flip-loans/",
        es: "https://www.myloandesk.com/es/loan-programs/fix-and-flip-loans/",
        "x-default":
          "https://www.myloandesk.com/loan-programs/fix-and-flip-loans/",
      },
    },
...
export default async function FixAndFlipLoansView({
  locale,
}: {
  locale: "en" | "es";
}) {
  ...
  const t = await getTranslations({
    locale,
    namespace: "FixAndFlipLoans",
  });
  const isEs = locale === "es";

  const homeHref = isEs ? "/es" : "/";
  const loanProgramsHref = isEs ? "/es/loan-programs" : "/loan-programs";
  const fixFlipHref = isEs
    ? "/es/loan-programs/fix-and-flip-loans"
    : "/loan-programs/fix-and-flip-loans";
  ...
  const breadcrumbItems = [
    ...
    { name: t("breadcrumbs.fix_and_flip"), url: fixFlipHref },
  ];
              ...
              <tbody>
                <tr className="border-b border-[#E6E0D3]">
                  ...
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.underwriting.fix_flip")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.underwriting.conventional")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.underwriting.heloc")}
                  </td>
                </tr>
                <tr className="bg-[#F3EFE6] border-b border-[#E6E0D3]">
                  <td className="p-[11px_14px] font-bold text-[#1C1C1C]">
                    {t("comparison.rows.closing_time.label")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.closing_time.fix_flip")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.closing_time.conventional")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.closing_time.heloc")}
                  </td>
                </tr>
                <tr className="border-b border-[#E6E0D3]">
                  <td className="p-[11px_14px] font-bold text-[#1C1C1C]">
                    {t("comparison.rows.rehab_financed.label")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.rehab_financed.fix_flip")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.rehab_financed.conventional")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.rehab_financed.heloc")}
                  </td>
                </tr>
                <tr className="bg-[#F3EFE6] border-b border-[#E6E0D3]">
                  <td className="p-[11px_14px] font-bold text-[#1C1C1C]">
                    {t("comparison.rows.payment_structure.label")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.payment_structure.fix_flip")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.payment_structure.conventional")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
                ...
                <tr className="border-b border-[#E6E0D3]">
                  ...
                  <td className="p-[11px_14px] text-[#55524C]">
                    {t("comparison.rows.best_for.fix_flip")}
                  </td>
                  <td className="p-[11px_14px] text-[#55524C]">
